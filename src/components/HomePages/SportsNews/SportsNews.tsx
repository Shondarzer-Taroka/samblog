    ...
    <section className="bg-gray-50 py-6 md:px-4 px-2">
      <div className="">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr_1fr] gap-6 mb-8">
                  ...
                  <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 group">
                    <div className="relative h-48 w-full overflow-hidden">
                      <Image
                        src={
                          item?.imageUrl ||
                          "https://cdn.jugantor.com/assets/news_photos/2025/06/24/Ben-Duckett-685ab3e5d7432.gif"
                        }
                        alt={item.title}
                        fill
          ...
          <div>
            <NewsCardWrapper
              href={`/news/${centerMain.category}/${centerMain.id}`}
              id={centerMain.id}
            >
              <div className="block group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                  ...
                  <div className="p-5 md:h-[244px]">
                    ...
                    <p className="text-gray-600 mb-4 text-[15.2px]">
                      {
                        stripHtmlAndLimitWithSpace(centerMain.content, 244)
                          .short
                      }
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="flex items-center text-sm text-gray-500">
                        <FaClock className="mr-1" />{" "}
                        {new Date(centerMain.createdAt).toLocaleDateString(
                          "bn-BD"
                        )}
                      </span>
