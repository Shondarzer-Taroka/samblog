    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-2 md:px-4  py-6">
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl md:px-4 px-2 py-6 shadow-sm">
          ...
          <button className="w-full more-read-btn  mt-6 py-3  text-white rounded-lg font-bold shadow-md hover:shadow-lg transition-all duration-300 transform  flex items-center justify-center">
            আরও পড়ুন
