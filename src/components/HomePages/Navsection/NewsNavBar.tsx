...
const mobileCategories = {
  'রাজনীতি ও ইস্যু': ['চলমান ইস্যু', 'রাজনীতি', 'অর্থনীতি', 'মুক্তিযুদ্ধ', 'বাংলাদেশ', 'আন্তর্জাতিক'],
...
const menuItems = [
  { key: 'home', label: 'মূলপাতা', href: '/', isMd: true },
  {
    ...
    label: 'বিষয়শ্রেণি',
    dropdown: [
      ['চলমান ইস্যু', 'রাজনীতি', 'অর্থনীতি', 'ধর্ম', 'ইসলাম', 'ইতিহাস', 'সংস্কৃতি', 'সাহিত্য'],
  ...
  },
  {
    ...
    label: 'জানুন',
    dropdown: [
      ['রাজনীতি', 'চলমান ইস্যু', 'বিবিধ', 'ধর্ম', 'ইসলাম', 'ইতিহাস', 'সংস্কৃতি', 'সাহিত্য'],
      ['বিজ্ঞান', 'গল্প', 'কবিতা', 'উপন্যাস', 'বুক রিভিউ', 'ছবিরূপ', 'বাংলাদেশ', 'আন্তর্জাতিক'],
      ['শিক্ষা', 'সমসাময়িক', 'তর্কযুদ্ধ', 'মুক্তচিন্তা', 'খেলাধুলা', 'মুক্তিযুদ্ধ', 'অপরাধ', 'শিশুত্ব'],
      ['প্রম', 'রান্নাবান্না', 'তথ্যপ্রযুক্তি', 'ব্যবস্থা', 'স্বাস্থ্যকথা', 'অর্থনীতি'],
    ]
  },
  { key: 'রাজনীতি', label: 'রাজনীতি', href: '/news/রাজনীতি', isMd: false },
  { key: 'আন্তর্জাতিক', label: 'আন্তর্জাতিক', href: '/news/আন্তর্জাতিক', isMd: false },
  { key: 'ইসলাম', label: 'ইসলাম', href: '/news/ইসলাম', isMd: false },
  { key: 'খেলাধুলা', label: 'খেলাধুলা', href: '/news/খেলাধুলা', isMd: false },
  { key: 'মুক্তিযুদ্ধ', label: 'মুক্তিযুদ্ধ', href: '/news/মুক্তিযুদ্ধ', isMd: false },
  { key: 'চাকরি', label: 'চাকরি', href: '/news/চাকরি', isMd: false },
];
      ...
      <div className="container mx-auto px-1 md:px-4">
        <nav className='flex items-center justify-between gap-0 md:gap-8 py-3'>
          ...
          <button
            ...
            className="md:hidden p-1 md:p-2 text-gray-600 hover:text-blue-600 transition-colors"
            aria-label="Menu"
          >
          ...
          {/* Desktop Navigation */}
          <ul className='hidden md:flex md:gap-4 lx:gap-8 items-center'>
            ...
            >
              <div className="container mx-auto px-4 py-3">
                ...
                <ul className="space-y-2">
                  {menuItems.filter(item => item.key !== 'categories').map(({ key, label, href, isMd }) => (
                    isMd && <li key={key}>
                      <button
