      ...
      <div className="">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="text-sm font-medium text-red-600 hover:text-red-800 transition-colors">
            <Link href={"/news/ইসলাম"}>সব দেখুন →</Link>
          </button>
        </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-gray-600 mb-3">
                        {stripHtmlAndLimit(article.content, 8).short}
                      </p>
                    </div>
                    <div className="flex space-x-2">
                      ...
                      <ClientShareTrigger
                        title={article.title}
                        url={`${process.env.NEXT_PUBLIC_BASE_URL}/news/${article.title}`}
                      />
                    </div>
                  </div>
              ...
              <div className="sticky top-4">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
                  <div className="relative h-48 bg-red-700 flex items-center justify-center">
                    <img
                      src={
                        islamicNews[4]?.imageUrl ||
                        "https://cdn.jugantor.com/assets/news_photos/2025/06/28/Untitled-1-685fce9f5b9b1.jpg"
                      }
                  ...
                  <div className="p-6">
                    ...
                    <NewsCardWrapper
                      id={islamicNews[4].id}
                      href={`/news/${islamicNews[4].category}/${islamicNews[4].id}`}
                    >
