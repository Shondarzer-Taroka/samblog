...
// import { DashboardData, HistoricalDataPoint } from '@/lib/api/dashboard-api';
...
// }) {
//   useEffect(() => {
//     if (dashboardData && historicalData.length > 0) {
//       renderBarCharts();
//       renderLineChart();
//       renderPieChart();
//     }
...
//       const modelData = dashboardData[model.key as keyof DashboardData];
//       const chartData = [
...
//     const pieData = [
//       { label: 'Users', value: dashboardData.users.year, color: '#3B82F6' },
//       { label: 'News', value: dashboardData.news.year, color: '#10B981' },
//       { label: 'Opinions', value: dashboardData.opinions.year, color: '#EC4899' },
//       { label: 'Comments', value: dashboardData.comments.year, color: '#8B5CF6' },
//       { label: 'Likes', value: dashboardData.likes.year, color: '#EF4444' },
//     ];
...
//               <p className="text-2xl font-bold text-blue-800">{dashboardData.users.year}</p>
//             </div>
...
//               <p className="text-2xl font-bold text-green-800">{dashboardData.news.year}</p>
//             </div>
...
//               <p className="text-2xl font-bold text-purple-800">{dashboardData.opinions.year}</p>
//             </div>
...
//               <p className="text-2xl font-bold text-red-800">{dashboardData.likes.year + dashboardData.comments.year}</p>
//             </div>
//           </div>
//         )}
//       </div>
