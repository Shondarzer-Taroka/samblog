...
// /// not working reusable component 





// // components/QuillEditor/index.ts
...
//       if (res.ok) {
//         showToast('success', 'সংবাদ সফলভাবে তৈরি হয়েছে');
//       } else {
//         showToast('error', result.error || 'সংবাদ তৈরি ব্যর্থ হয়েছে');
//       }
//     } catch (error) {
//       showToast('error', 'সার্ভার সমস্যা হয়েছে');
//       console.error(error);
//     } finally {
//       setIsSubmitting(false);
//     }
